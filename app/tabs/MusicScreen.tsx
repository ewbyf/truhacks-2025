...
export default function MusicScreen() {
	...
	const [prompt, setPrompt] = useState('Generate me a song with these topics');

	// lyrics will have to be generated by chat gpt

	const handleCreateSong = async () => {
		try {
			const payload = {
				custom_mode: false,
				prompt: `In the topic of ${selectedTopic}, make a song that teaches me about`,
				tags: selectedGenre,
				mv: "sonic-v3-5",
				topic: selectedTopic,
				genre: selectedGenre,
			...
			// You can do something with the response here (navigate, show success, etc.)
		} catch (error) {
					...
					<View style={styles.field}>
						...
						<View style={{ borderRadius: 10, overflow: 'hidden' }}>
							<RNPickerSelect
								...
								items={topics}
								placeholder={{ label: 'What would you like to learn about?', value: null }}
